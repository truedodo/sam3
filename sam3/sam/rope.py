...
def apply_rotary_enc(
    ...
    if repeat_freqs_k:
        ...
        freqs_cis_real = freqs_cis.real.repeat(*([1] * (freqs_cis.ndim - 2)), r, 1)
        freqs_cis_imag = freqs_cis.imag.repeat(*([1] * (freqs_cis.ndim - 2)), r, 1)
        freqs_cis = torch.complex(freqs_cis_real, freqs_cis_imag)
